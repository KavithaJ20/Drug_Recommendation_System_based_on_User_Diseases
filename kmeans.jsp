<%-- 
    Document   : kmeans
    Created on : Feb 13, 2018, 6:09:36 PM
    Author     : DLK
--%>
...
<%@page import="algm.KMeansClustering"%>
...
<html>
    ...
    <body>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <nav>
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="KmeansCalculate" class="active">Kmeans</a></li>
        ...
        <!-- about-bottom -->
        <br>
        <h2 style="margin-left: 342px;color:red;">K Means Clustering Result</h2>
        <br>
        <p style="color:#000;margin-left: 342px;">
            <%
