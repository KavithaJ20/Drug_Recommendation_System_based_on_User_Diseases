<%-- 
    Document   : register
    Created on : Jan 27, 2018, 11:00:24 AM
    Author     : DLK
--%>
	...
	<center>
            <h2>User SignUp</h2><br>		
                    <form action="reg.jsp">
                        ...
                        <strong>Firstname&emsp;&nbsp;</strong><input type="text" name="fname" required="" value="" style="width:200px;" /><br><br>
                        <strong>Lastname&emsp;&nbsp;&nbsp;</strong><input type="text" name="lname" required="" value="" style="width:200px;" /><br><br>
                        <strong>Email Id &emsp;&nbsp;&nbsp;&nbsp;</strong><input type="email" name="email" required=""  style="width:200px;" value="" /><br><br>
                        <strong>Mobile &emsp;&emsp;&nbsp;&nbsp;</strong><input type="text" name="mobile" required=""  style="width:200px;" value="" /><br><br>
