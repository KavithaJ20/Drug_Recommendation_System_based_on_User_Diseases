<%-- 
    Document   : index
    Created on : Jan 26, 2018, 7:38:05 PM
    Author     : DLK
--%>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								<li><a href="index.jsp" class="active">Upload Dataset</a></li>
...
<div class="agile-about w3ls-section">
	...
	<form action="Upload" method="POST" enctype="multipart/form-data" >
            <center>   
                <h1 style="color: #055ffc;">Upload File </h1> <br><br>     
                <table width="345" border="1" bgcolor="#99CC00">                     
                    <tr><th height="33" width="280">Upload File Here</th> 
                    <td><input type="file" name="file"/></td></tr> 
                    <tr><th height="39" colspan="2"><input type="submit" value="Upload Data Set"/></th></tr> 
                </table>
            </center>
       </form>	<br><br><br>
	</div>
